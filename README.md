...
Delete the state file winhome.state.json (located in the same directory).
...
Format: dotnet format WinHome.sln (required before submitting)

Open a Pull Request and link it to the relevant issue (Closes #<issue-number>)
