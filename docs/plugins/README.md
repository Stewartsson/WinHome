...
| [Scoop](./scoop.md) | Command-line Installer Provisioning Framework | `package_manager` | [Details](./scoop.md) |
| [Miniconda](./miniconda.md) | Python/R Package and Environment Manager | `package_manager` | [Details](./miniconda.md) |
| [Sdkman](./sdkman.md) | Software Development Kit Manager for Java Ecosystem | `package_manager` | [Details](./sdkman.md) |
| [7-Zip](./7-zip.md) | High-Ratio File Archiver and Compression Tool | - | [Details](./7-zip.md) |
| [Syncthing](./syncthing.md) | Continuous File Synchronization Framework | - | [Details](./syncthing.md) |
